...
const searchableItems = [
  ...
  { name: 'Biker Leather Jacket', type: 'Product', link: '/product/8', image: "url('/images/shoes/zara1.jpeg') center/cover" },
  { name: 'Canvas Tote', type: 'Product', link: '/product/9', image: 'linear-gradient(135deg, #FD79A8, #FAB1A0)' },
  { name: 'Chunky Sneakers', type: 'Product', link: '/product/10', image: "url('/images/shoes/diki1.jpeg') center/cover" },
