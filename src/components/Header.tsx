...
const searchableItems = [
  ...
  { name: 'Biker Leather Jacket', type: 'Product', link: '/product/8', image: 'linear-gradient(135deg, #2D3436, #636E72)' },
  { name: 'Canvas Tote', type: 'Product', link: '/product/9', image: 'linear-gradient(135deg, #FD79A8, #FAB1A0)' },
  { name: 'Chunky Sneakers', type: 'Product', link: '/product/10', image: 'linear-gradient(135deg, #0984E3, #74B9FF)' },
  ...
  { name: 'Shoes', type: 'Category', link: '/category/shoes', image: 'linear-gradient(135deg, #0984E3, #74B9FF)' },
